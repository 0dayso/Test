using RoyalWebApp.Account;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using System;
using Microsoft.VisualStudio.TestTools.UnitTesting.Web;

namespace TestRoyalApp
{
    ...
    public class LoginTest
    {
        ...
        [TestMethod()]
        [HostType("ASP.NET")]
        [AspNetDevelopmentServerHost("E:\\workarea\\KOD_RoyalCard\\WebApp\\RoyalWebApp\\RoyalWebApp", "/")]
        [UrlToTest("http://localhost:2483/")]
        [DeploymentItem("RoyalWebApp.dll")]
