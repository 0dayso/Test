    ...
    public partial class Membership : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["mailer"] == "Royal_member")
                {
                    string Ip = GetIP();
                    string cmd = "INSERT INTO [dbo].[Royal_MailerTracker](IP,Date,Source) OUTPUT Inserted.ID,inserted.EMail,inserted.IP,inserted.Name,inserted.Date VALUES('" + Ip + "',getdate(),'" + Request.QueryString["mailer"].ToString() + "')";
