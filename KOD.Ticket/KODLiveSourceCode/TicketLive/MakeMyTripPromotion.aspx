...
.seats-inside1
{
    width: 846px;
    float: left;
    background: url(images/newmmt.jpg) no-repeat;
    overflow: auto;
    height: 489px;
    padding-left:245px;
    *padding-left:245px;
    ...
    <div class="wrapper">
        ...
        <div class="seats-main">
            ...
            <asp:UpdateProgress ID="uppero" runat="server" DynamicLayout="true">
                        <ProgressTemplate>
                            <div style="height: 355px; background-color: #C79EA7; width: 295px; position: absolute;
     ...
     <div id="dv_pop" class="ModalWindow" style="display: none; width: 550px; height: 160px;"
        runat="server">
              
        <div id="Div1" runat="server" style="overflow: auto; width: 530px; height: 120px; padding: 0px 10px 0px 10px">

           
          <font color="red"> <u><b> <center>Package Details</center></b></u></font>
           <p>1. These discounts cannot be clubbed with any other promotion and are subject to availability.<br /><br />
                    2. All the Terms & Conditions of Jhumroo/Zangoora are also applied.</p>
