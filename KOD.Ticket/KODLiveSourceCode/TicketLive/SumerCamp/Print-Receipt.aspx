<%@ Page Title="" Language="C#" MasterPageFile="~/Receipt.master" AutoEventWireup="true" CodeFile="Print-Receipt.aspx.cs" Inherits="Sumer_Camp_Print_Receipt" %>
    ...
    <div id="dvDetails" runat="server">
        <div id="DivPrint" style="overflow: auto; width: 100%"  style="height:600px">
            ...
            <%--    <td style="width: 597px">
                ...
                <tr>
                <td colspan="7">
                <p>Your transaction is successful, please bring this Booking ID to the Box Office to collect Summer camp tickets along with the credit card used for booking.</p>
