<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Audit/AuditReport.master" CodeFile="AdditionalReport1.aspx.cs" Inherits="Audit_AdditionalReport1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="Server">
    <asp:UpdatePanel ID="upd1" runat="server">
        <ContentTemplate>
            <span style="font-size: medium; font-weight: bold;">Report - Audit No 1 </span>
            <br />
            ...
            <table width="100%">
                ...
                <tr>
                    <td colspan="3">
                        <asp:Button ID="Btn_ShowAuditNo1" runat="server" OnClick="btnCreateAudit_Click" Text=" Show Audit Report" ValidationGroup="show" OnClientClick="javascript:return validInsert();"/>
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="Btn_ShowAuditNo1" />
