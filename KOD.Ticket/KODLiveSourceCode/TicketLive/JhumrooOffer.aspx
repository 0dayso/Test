<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Event.master" CodeFile="JhumrooOffer.aspx.cs" Inherits="JhumrooOffer" %>
        ...
        $(document).ready(function () {
            Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function (evt, args) {
                ...
                $("input[type=checkbox]").change(function () {
                    ...
                    if (test == "ctl00_ContentPlaceHolder2_chkterms" && ischecked == "checked") {
                        $("#grayBG").show();
                        $("#Container").show();
                    }
                    else if (test == "ctl00_ContentPlaceHolder2_chkterms" && ischecked != "checked") {
