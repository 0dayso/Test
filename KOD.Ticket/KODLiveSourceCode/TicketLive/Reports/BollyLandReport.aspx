<%@ Page Language="C#" MasterPageFile="~/Reports/Report.master" AutoEventWireup="true" CodeFile="BollyLandReport.aspx.cs" Inherits="Reports_BollyLandReport" %>
                ...
                <tr align="right">
                    ...
                    <td colspan="3">
                        <asp:Button ID="btnGo" runat="server"  
                            Text="  Fetch Data " onclick="btnGo_Click" />
