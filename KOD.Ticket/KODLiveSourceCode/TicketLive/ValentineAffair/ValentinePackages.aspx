<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ValentinePackages.aspx.cs" Inherits="ValentineAffair_ValentinePackages" %>
                ...
                <div class="ticket-main">
                  ...
                  <td>
                    ...
                    <asp:DropDownList ID="ddl_Package1" runat="server" CssClass="text-small" Width="200px">
                            ...
                            <asp:ListItem>Couple Rs.3499</asp:ListItem>
                            <asp:ListItem>Couple Rs.4249</asp:ListItem>
                            <asp:ListItem>Couple Rs.5499</asp:ListItem>
  ...
  <asp:LinkButton ID="Button2" CssClass="clickhere" runat="server" Text="Click Here"/></div>
    ...
    <div id="Div_popup" class="ModalWindow" style="display: none; width: 380px; height: 250px;"
        ...
        <h3>
            ...
            <ol>
                <li><u><font color="red">Rs 5499 per couple:</font></u>  Entertainment Evening , Jhumroo - A Musical Comedy on Stage, Reverse Bungee, Unlimited Food & Beverage.</li>
                <br />
                <li><u><font color="red">Rs 4249 per couple:</font></u> Entertainment Evening, Reverse Bungee, Unlimited Food & Beverage.</li>
                <br />
                <li><u><font color="red">Rs 3499 per couple:</font></u>  Entertainment Evening, Unlimited Food & Beverage.</li>
           ...
           <%-- <b><font color="red">
            ...
            <ol>
                ...
                <li>This ticket is not valid for the shows i.e. Zangoora and Jhumroo.</li>
                 <li>Kids below the age of 5 years are not allowed inside the Showshaa Theater.</li>   
...
<script language="javascript" type="text/javascript">
    function validInsert() {
        var packag = document.getElementById("<%=ddl_Package1.ClientID %>");
        if (packag.value == "0") {
            alert("Please Select atleast One Package");
            packag.focus();
            return false;
        }
        var Quantity = document.getElementById("<%=ddl_Quantity.ClientID %>");
        if (Quantity.value == "0") {
        ...
        var mailid = document.getElementById("<%=txtEmail.ClientID %>");
        if (mailid.value == "") {
