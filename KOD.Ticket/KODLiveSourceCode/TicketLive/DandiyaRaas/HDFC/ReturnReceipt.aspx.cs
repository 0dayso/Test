...
public partial class ValentineAffair_HDFC_ReturnReceipt : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            Microsoft.Practices.EnterpriseLibrary.Logging.Logger.Write(responseDetails);
                  ...
                  if (trackid != String.Empty)
                 {
                    ...
                    {
                        string redirectURL = "REDIRECT=" + KoDTicketingIPAddress + "DandiyaRaas/Print-Receipt.aspx" + qstring;
                  ...
                  Response.Write("REDIRECT=" + KoDTicketingIPAddress + "DandiyaRaas/Print-Receipt.aspx?err=pay");
...
# region CAPTURED
                ...
                try
                {
                    ...
                    TransactionBOL.Get_Dandiya_Details(tr.VLBookingID, tr.VLReceiptNo);
                    ...
                    DataTable dt = TransactionBOL.Select_DandiyaTransaction(tr.VLBookingID.ToString());
                    ...
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        ...
                        try
                        {
                            ...
                            ReceiptUtils.DandiyaPaymentSuccess(dt.Rows[0], tr.VLReceiptNo.ToString(), tr.BookingID.ToString());
                         ...
                         catch (Exception ex)
                        {
                            ...
                            ReceiptUtils.DSuccessPaymentResponse(tr.VLReceiptNo.ToString(), dt.Rows[0], "");
                    ...
                    else
                    {
                        ...
                        DataTable dt1 = TransactionBOL.Select_DandiyaTransaction(tr.VLBookingID.ToString());
                        ReceiptUtils.DSuccessPaymentResponse(tr.VLReceiptNo.ToString(), dt1.Rows[0], "");
                        //ReceiptUtils.SuccessPaymentResponse(tr.VLBookingID.ToString(), tr.VLReceiptNo);
                        qstring.Append((qstring.Length == 0) ? "?err=seat" : "&err=seat");
                    }
                }
                ...
                string BookingID = tr.VLBookingID.ToString();
                  try
                {
                    DataTable dt = TransactionBOL.Select_DandiyaTransaction(BookingID);
                ...
                Response.Redirect(IpAddress + "DandiyaRaas/HDFC/FinalCall.aspx" + qstring.ToString(), false);
#endregion
              } 
            else
            {
