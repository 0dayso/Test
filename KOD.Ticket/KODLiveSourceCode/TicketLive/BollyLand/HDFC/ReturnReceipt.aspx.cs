        ...
        if (!IsPostBack)
        {
            ...
            if (ErrorNo == String.Empty)
            {
                ...
                if (trackid != String.Empty)
                {
                    ...
                    {
                        string redirectURL = "REDIRECT=" + KoDTicketingIPAddress + "BollyLand/Print-Receipt.aspx" + qstring;
                ...
                Response.Write("REDIRECT=" + KoDTicketingIPAddress + "BollyLand/Print-Receipt.aspx?err=pay");
            }
            else
            {
...
# region CAPTURED
                ...
                try
                {
                    ...
                    TransactionBOL.Get_BollyLand_Detail(tr.NYBookingID, tr.NYReceiptNo);
                    ...
                    DataTable dt = TransactionBOL.Select_BollyLandTransaction_REFIDWISE(tr.NYBookingID.ToString());
                    ...
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        ...
                        try
                        {
                            ...
                            ReceiptUtils.BollyLandPaymentResponse(dt.Rows[0], tr.NYReceiptNo.ToString(), tr.BookingID.ToString(), ConfigurationManager.AppSettings.Get("ConcertRefMailId1"));
                ...
                Response.Redirect(IpAddress + "BollyLand/HDFC/FinalCall.aspx" + qstring.ToString(), false);
#endregion
            } 
            else
            {
