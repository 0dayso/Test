...
public partial class ContactDetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["SessionId"] != null || Request.QueryString["SessionId"].ToString() != "")
        {
            ...
            if (strarr[10].ToString() == "")
            {
                ...
                if (Convert.ToDecimal(strarr[5].ToString()) > 3 && strarr[1].ToString() == "JHUMROO" && strarr[8].ToString() != "BRONZE" && strarr[8].ToString() != "COPPER" && Present <= End)
                {
                    lblttlAmt.Visible = true;
                    lblpayAmt.Visible = true;
                    if (Convert.ToDecimal(strarr[5].ToString()) <= 7)
                    {
                        lblpayAmt.Text = "Total Payable Amount : Rs. " + Convert.ToDecimal(strarr[9].ToString().Split('.')[1].ToString()) * (Convert.ToDecimal(strarr[5].ToString()) - 1) + " (pay for only '" + (Convert.ToDecimal(strarr[5].ToString()) - 1) + "' tickets)";
                        lblttlAmt.Text = "Total Amount : Rs. " + Convert.ToDecimal(strarr[9].ToString().Split('.')[1].ToString()) * Convert.ToDecimal(strarr[5].ToString()) + " (for '"+strarr[5]+"' tickets)";
                    }
                    else 
                    {
                        lblpayAmt.Text = "Total Payable Amount : Rs. " + Convert.ToDecimal(strarr[9].ToString().Split('.')[1].ToString()) * (Convert.ToDecimal(strarr[5].ToString()) - 2) + " (pay for only '" + (Convert.ToDecimal(strarr[5].ToString()) - 2) + "' tickets)";
                        lblttlAmt.Text = "Total Amount : Rs. " + Convert.ToDecimal(strarr[9].ToString().Split('.')[1].ToString()) * Convert.ToDecimal(strarr[5].ToString()) + " (for '" + strarr[5] + "' tickets)";
                    }

                }
                //else if (strarr[1].ToString() == "JHUMROO" && (strarr[4].ToString() == "GLY" || strarr[4].ToString() == "SL" || strarr[4].ToString() == "GL" || strarr[4].ToString() == "PL" || strarr[4].ToString() == "DM") && Presentt <= Endt)
                //{
                //    lblttlAmt.Visible = true;
                //    lblpayAmt.Visible = true;
            ...
            else if (strarr[10].ToString() != "")
            {
                ...
                else if (PromoSession.PromotionCode.ToUpper() == "MANA")
                {
                    if (strarr[11]!="")
                    {
                        if (PromoSession.PromotionCode.ToUpper() == "MANA" && strarr[11].ToString() == "Weekend,Rs.4999")
                        {
                            lblttlAmt.Visible = true;
                            lblpayAmt.Visible = true;
                            decimal ManaTotalAmount = Convert.ToDecimal(Session["TotalAmount"].ToString()) + 1000;
                        ...
                        else if (PromoSession.PromotionCode.ToUpper() == "MANA" && strarr[11].ToString() == "Weekday,Rs.3999")
                        {
                            lblttlAmt.Visible = true;
                            lblpayAmt.Visible = true;
                            decimal ManaTotalAmount = Convert.ToDecimal(Session["TotalAmount"].ToString()) + 1000;
            ...
            " the transaction again');window.location.href='Default.aspx';</script>");
                ...
                else if (PromoSession.PromotionCode.ToUpper() == "MMT")
                {
                    if (strarr[11]!="")
                    {
                        if (PromoSession.PromotionCode == "MMT" && strarr[11].ToString() == "4500")
                        {
                            lblttlAmt.Visible = true;
                            lblpayAmt.Visible = true;
    ...
    {
        string ShowDate = "";
        string[] datarr1 = sessionvalue[2].ToString().Split('/');//for live server
            ...
            try
            {
                ...
                if (Session_value != "" && Request.QueryString["SessionId"] != null)
                {
                    try
                    {
                        ...
                        if (strarr[10] == "LEELAKEMPINSKI" && chkGCab.Checked)
                        {
                        ...
                        if (strarr[10] == "CROWNPLAZA" && (chkGCabPick.Checked || chkGCabDrop.Checked))
                        {
                        ...
                        else if (Convert.ToDecimal(strarr[5].ToString()) > 3 && strarr[1].ToString() == "JHUMROO" && strarr[8].ToString() != "BRONZE" && strarr[8].ToString() != "COPPER" && Present <= End)
                        {
                            if (Convert.ToDecimal(strarr[5].ToString()) <= 7)
                            {
                                tr.PayableAmount = GTICKBOL.Get_SeatPrice_SeatKeyNoWise(tr.BookingID) - GTICKBOL.Get_SeatPrice_SeatKeyNoWise(tr.BookingID)/Convert.ToDecimal(strarr[5].ToString());
                                tr.DiscountPercentage = ((tr.TotalAmount - tr.PayableAmount) / tr.TotalAmount) * 100;
                                tr.DiscountPercentage = Math.Round(tr.DiscountPercentage, 2, MidpointRounding.AwayFromZero);
                            }
                            else
                            {
                                tr.PayableAmount = GTICKBOL.Get_SeatPrice_SeatKeyNoWise(tr.BookingID) - ((GTICKBOL.Get_SeatPrice_SeatKeyNoWise(tr.BookingID) / Convert.ToDecimal(strarr[5].ToString()))*2);
                                tr.DiscountPercentage = ((tr.TotalAmount - tr.PayableAmount) / tr.TotalAmount) * 100;
                                tr.DiscountPercentage = Math.Round(tr.DiscountPercentage, 2, MidpointRounding.AwayFromZero);
                            }
                        }
                        ...
                        //if (strarr[1].ToString() == "JHUMROO" && (strarr[4].ToString() == "GLY" || strarr[4].ToString() == "SL" || strarr[4].ToString() == "GL" || strarr[4].ToString() == "PL" || strarr[4].ToString() == "DM") && strarr[10].ToString() == "" && Presentt <= Endt)
                        //{
                        ...
                        //if (Session["Package"] == null || Session["Package"].ToString() == "")
                        //{
                        //    Session["Package"] = "";
                        //}

                        if (strarr[11] != "" || strarr[10] == "OCTOBERFEST" || strarr[10] == "JHUMROOOFFER")
                            {
                    ...
                    if (sessionvalue[10] != "")
                    {
                        ...
                        else if (ObjPromoSession.PromotionCode == "MMT")
                        {
                            if (strarr[11] != "")
                            {
                                if (strarr[11] == "4500" || ObjPromoSession.PromotionCode == "MMT")
                                {
                                    ...
                                    //Microsoft.Practices.EnterpriseLibrary.Logging.Logger.Write("values for mmtus"+Convert.ToInt16(Session["NoofPackages"])+","+Session["pnr"].ToString()+","+ Session["promocode"].ToString()+","+ Convert.ToDecimal(Session["TotalAmount"].ToString())+","+ Convert.ToDecimal(Session["PayableAmount"].ToString())+","+ Convert.ToDateTime(tr.DateOfBooking.ToString())+","+ tr.BookingID.ToString()+","+ day1+","+ Session["Name"].ToString()+","+ Session["Email"].ToString()+","+ Session["ContactNo"].ToString()+","+ Session["Paymentgateway"].ToString()+","+" false"+","+ "");
                        ...
                        else
                        {
                            ...
                            if (ObjPromoSession.PromotionCode == "YATRA")
                            {
                                ...
                                transid = GTICKBOL.YATRABooking_Details(Convert.ToInt16(Session["NoofTickets"]), Session["yatrapnr"].ToString(), sessionvalue[10], strarr[4].ToString(), tr.DiscountPercentage, tr.TotalAmount, tr.DiscountedAmount, Convert.ToDateTime(tr.DateOfBooking.ToString()), tr.BookingID.ToString(), Convert.ToDateTime(tr.ShowDate.ToString()), tr.Name.ToString(), tr.EmailID.ToString(), tr.MobileNo.ToString(), tr.PaymentGateway.ToString(), false, "", transid.ToString());
                            }
                        ...
                        if (strarr[11] != "")
                        {
                           // KoDTicketingLibrary.DTO.Promotion PromoSession = (KoDTicketingLibrary.DTO.Promotion)Session["PromotionCode"];
                            if (strarr[11] == "Rs.1275")
                            {
                                ...
                                GTICKBOL.March_Promotion(tr.Category, tr.BookingID, tr.DateOfBooking, tr.TotalSeats, tr.TotalAmount, strarr[11].ToString(), 0);
                            }
                    ...
                    else if (Convert.ToDecimal(sessionvalue[5].ToString()) > 3 && sessionvalue[1].ToString() == "JHUMROO" && sessionvalue[8].ToString() != "BRONZE" && sessionvalue[8].ToString() != "COPPER" && Present <= End)
                    {
                        if (Convert.ToDecimal(sessionvalue[5].ToString()) <= 7)
                        {
                            tr.TotalAmount = tr.PayableAmount;
                        }
                        else
                        {
                            tr.TotalAmount = tr.PayableAmount;
                    ...
                    //if (sessionvalue[1].ToString() == "JHUMROO" && (sessionvalue[4].ToString() == "GLY" || sessionvalue[4].ToString() == "SL" || sessionvalue[4].ToString() == "GL" || sessionvalue[4].ToString() == "PL" || sessionvalue[4].ToString() == "DM") && sessionvalue[10].ToString() == "" && Presentt <= Endt)
                    //{
