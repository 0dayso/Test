...
namespace KoDTicketing.Utilities
{
    ...
    {
        //protected const string SMSServiceURI = "http://www.myvaluefirst.com/smpp/sendsms";
        //protected const string SMSapiUsername = "greatindiannpl";
        //protected const string SMSapiPassword = "grin56np";
        ...
        public string SendSMS_Sender(string mobileNo, string message, string senderID)
        {
            ...
            try
            {
                ...
                myResp.Close();
                Microsoft.Practices.EnterpriseLibrary.Logging.Logger.Write("sendsms in try");
