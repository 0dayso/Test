        ...
        if (!IsPostBack)
        {
            ...
            if (ErrorNo == String.Empty)
            {
                ...
                if (trackid != String.Empty)
                {
                    ...
                    {
                        string redirectURL = "REDIRECT=" + KoDTicketingIPAddress + "EventTransaction/Print-Receipt.aspx" + qstring;
                ...
                Response.Write("REDIRECT=" + KoDTicketingIPAddress + "EventTransaction/Print-Receipt.aspx?err=pay");
            }
            else
            {
