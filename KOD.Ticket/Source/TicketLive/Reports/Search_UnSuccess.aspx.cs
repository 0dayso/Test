...
public partial class Search_UnSuccess : System.Web.UI.Page
{
    ...
    protected void gv_Report_RowDataBound(object sender, GridViewRowEventArgs e)
    {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                discountamt = discountamt + decimal.Parse(((DataRowView)e.Row.DataItem).Row.ItemArray[10].ToString());
            }
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                (e.Row.FindControl("lbldisamt") as Label).Text = discountamt.ToString();
            }
