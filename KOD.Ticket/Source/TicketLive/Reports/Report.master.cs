...
public partial class Reports_Report : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //maenu.Items[0].Enabled = false;
            //maenu.Items[1].Enabled = false;
            //maenu.Items[2].Enabled = false;
            //maenu.Items[3].Enabled = false;
            //maenu.Items[4].Enabled = false;
            //maenu.Items[6].Enabled = false;
            if (!IsPostBack)
            {
