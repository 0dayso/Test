<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Report.master" AutoEventWireup="true" CodeFile="Valentine_Report.aspx.cs" Inherits="Reports_Valentine_Report" %>
        ...
        <ContentTemplate>
            ...
            <table width="100%">
                ...
                <asp:DropDownList ID="ddlPackage" runat="server">
                            ...
                            <asp:ListItem Value="1" >Couple Rs.5499</asp:ListItem>
                            <asp:ListItem Value="2">Couple Rs.4249</asp:ListItem>
                            <asp:ListItem Value="3">Couple Rs.3499</asp:ListItem>
                        </asp:DropDownList>
                </td>
                </tr>
                <%--<tr>
