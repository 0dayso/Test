    ...
    private void PayNowLive()
    {
        try
        {
            ...
            if (Session["PayDetailsTemp"] != null)
            {
                ...
                conn.addDigitialOrderField("vpc_ReturnURL", System.Configuration.ConfigurationManager.AppSettings["KoDTicketingIPAddress"] + "RoyalCard/Account/Payment/Web/CR.aspx");                
