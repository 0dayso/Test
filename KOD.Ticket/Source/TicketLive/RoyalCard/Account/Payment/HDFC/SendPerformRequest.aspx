...
{   
		try
		{
            ...
            string TranTrackid = Session["trackid"] != null ?  Session["trackid"].ToString()  : "10461";
			string TranAmount= Session["amount"] != null  ? Session["amount"].ToString() : "5.00";
            Microsoft.Practices.EnterpriseLibrary.Logging.Logger.Write("SendPerformRequest TranTrackid:" + TranTrackid + " TranAmount: " + TranAmount);
            ...
            //string ReqTranportalId = "id=" + HDFCTransPortalID + "&";
            string ReqTranportalId = "id=90001457&";
			...
			Tranportal password */
            //string ReqTranportalPassword = "password=" + HDFCTranportalPwd + "&";
            ...
            string ReqResponseUrl = "responseURL=" + KoDTicketingIPAddress + "RoyalCard/Account/Payment/HDFC/GetHandleHDFCResponse.aspx" + "&";
			...
			*/
            string ReqErrorUrl = "errorURL=" + KoDTicketingIPAddress + "RoyalCard/Account/Payment/HDFC/Error.aspx" + "&";
			...
			are not utilized */
			string ReqUdf1 = "udf1="+""+"&";		// UDF1 values                                                                
			string ReqUdf2 = "udf2="+""+"&";		// UDF2 values 	                                                               
			string ReqUdf3 = "udf3="+""+"&";	 	// UDF3 values                                                             
			string ReqUdf4 = "udf4="+""+"&";	 	// UDF4 values                                                                
			string ReqUdf5 = "udf5="+""+"&";		// UDF5 values 
           ...
           Microsoft.Practices.EnterpriseLibrary.Logging.Logger.Write(TranRequest);
           ...
           using (System.IO.StreamReader sr =new System.IO.StreamReader(objResponse.GetResponseStream()))
                {
					...
					if (ErrorCheck[0]!= "ERROR")//This block will check for Error in TranResponce
					{
                            ...
                            Microsoft.Practices.EnterpriseLibrary.Logging.Logger.Write("SendPerformRequest: redirecting the customer browser from KoD site to Payment Gateway Page with the Payment ID");
                            Response.Redirect(TranRedirect, false);
					}
					else
					{

                        Microsoft.Practices.EnterpriseLibrary.Logging.Logger.Write("SendPerformRequest: Error Encountered");
                        string TranErrorUrl = KoDTicketingIPAddress + "RoyalCard/Account/Payment/HDFC/FailedTRAN.aspx?Message=Transaction Failed&ResTrackId=" + TranTrackid + "&ResAmount=" + TranAmount + "&ResError=" + TranResponse;
		...
		{
            Microsoft.Practices.EnterpriseLibrary.Logging.Logger.Write("SendPerformRequest --> " + ex.Message);
