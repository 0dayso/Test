    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 524px">
                ...
                <tr class="style3" style="vertical-align: top">
                    <td  colspan="3">
                        <asp:Label ID="lblWarning" runat="server" Text="Minimum Payable Amount through credit/debit card is Rs. 50." ForeColor="Red"></asp:Label>
                    </td>
