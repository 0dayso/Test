        ...
        if (!IsPostBack)
        {
            ...
            Microsoft.Practices.EnterpriseLibrary.Logging.Logger.Write(responseDetails);
                  ...
                  if (trackid != String.Empty)
                {
                    ...
                    {
                        string redirectURL = "REDIRECT=" + KoDTicketingIPAddress + "ValentineAffair/Print-Receipt.aspx" + qstring;
                ...
                Response.Write("REDIRECT=" + KoDTicketingIPAddress + "ValentineAffair/Print-Receipt.aspx?err=pay");
...
# region CAPTURED
                ...
                try
                {
                    ...
                    TransactionBOL.Get_Valentine_Details(tr.VLBookingID, tr.VLReceiptNo);
                    ...
                    DataTable dt = TransactionBOL.Select_ValentineTransaction(tr.VLBookingID.ToString());
                ...
                string BookingID = tr.VLBookingID.ToString();
                  try
                {
                    DataTable dt = TransactionBOL.Select_ValentineTransaction(BookingID);
                ...
                Response.Redirect(IpAddress + "ValentineAffair/HDFC/FinalCall.aspx" + qstring.ToString(), false);
#endregion
              } 
            else
            {
