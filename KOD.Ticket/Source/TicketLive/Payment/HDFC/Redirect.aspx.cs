    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ErrorNo == null)
        {
            ...
            if (result == "CAPTURED")
            {
                ...
                Response.Write("REDIRECT=" + IpAddress + "Payment/HDFC/Result.aspx?paymentId=" + paymentId + "&result=" + result + "&auth=" + auth + "&ref=" + refence + "&amt=" + amt + "&postdate=" + postdate + "&trackid=" + trackid + "&tranid=" + tranid + "&udf1=" + udf1 + "&udf2=" + udf2 + "&udf3=" + udf3 + "&udf4=" + udf4 + "&udf5=" + udf5);
            }
            else
            {
                Response.Write("REDIRECT=" + IpAddress + "Payment/HDFC/Error.aspx?paymentId=" + paymentId + "&ErrorText=" + result + "&auth=" + auth + "&ref=" + refence + "&amt=" + amt + "&postdate=" + postdate + "&trackid=" + trackid + "&tranid=" + tranid + "&udf1=" + udf1 + "&udf2=" + udf2 + "&udf3=" + udf3 + "&udf4=" + udf4 + "&udf5=" + udf5);
            }
        }
        else
        {
            Response.Write("REDIRECT=" + IpAddress + "Payment/HDFC/Error.aspx?paymentId=" + paymentId + "&ErrorText=" + ErrorText);
        }
