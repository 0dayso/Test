...
{   
		try
		{
			...
			string ReqResponseUrl = "responseURL=" + KoDTicketingIPAddress + "Payment/HDFC/GetHandleHDFCResponse.aspx"+"&";
			...
			*/
            string ReqErrorUrl = "errorURL=" + KoDTicketingIPAddress + "Payment/HDFC/Error.aspx" + "&";
           ...
           using (System.IO.StreamReader sr =new System.IO.StreamReader(objResponse.GetResponseStream()))
                {
					...
					else
					{
                        ...
                        string TranErrorUrl = KoDTicketingIPAddress + "Payment/HDFC/FailedTRAN.aspx?Message=Transaction Failed&ResTrackId=" + TranTrackid + "&ResAmount=" + TranAmount + "&ResError=" + TranResponse;
