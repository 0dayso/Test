                ...
                else
                {
                    if (Request.QueryString["b"] != null)
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            if (dr["PromotionCode"].ToString() == "VIVANTABYTAJ" || dr["PromotionCode"].ToString() == "OBEROI" || dr["PromotionCode"].ToString() == "TRIDENT" || dr["PromotionCode"].ToString() == "OBEROIDELHI" || dr["PromotionCode"].ToString() == "OCTOBERFEST" || dr["PromotionCode"].ToString() == "JHUMROOOFFER")
                            {
                                lbltranamt.Text = dr["PayableAmount"].ToString() + "INR";
                            }
                            ...
                            if (dr["PromotionCode"].ToString() == "FAMILYOFFER")
                            {
                                notes.Visible = false;
                                DataTable dt1 = TransactionBOL.Select_FAMILYOFFERTransaction_REFIDWISE(BookingID.ToString());
                                DataRow dr1 = dt1.Rows[0];
                                lbltranamt.Text = decimal.Truncate(Convert.ToDecimal(dr1["PackagePayableAmount"].ToString())) + " INR";
                            }
