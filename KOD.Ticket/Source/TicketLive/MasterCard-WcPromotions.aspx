<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MasterCard-WcPromotions.aspx.cs" Inherits="MasterCardPromotions" %>
...
.seats-inside1
{
    width: 846px;
    float: left;
    background: url(images/master_card_promotion.jpg) no-repeat;
    overflow: auto;
    height: 489px;
    padding-left:245px;
    *padding-left:245px;
        ...
        <div class="seats-main">
            <div class="seats-inside1">
                ...
                <br /><br /><br /><br /> <br /><br /><br /><br /><br />
                 <table>
                <tr> 
                <td colspan="2" >Enter Your Master Card World card Number Below (First Six Digits):</td>
                </tr>
                <tr> 
                ...
                <tr> 
                <td colspan="2" id="div2" runat="server" >Select Your Bank Name:</td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                <td colspan="2">Enter Your Promotion Code Below:</td>
                </tr>
                <tr>
                <td colspan="2">
                ...
                Text="Proceed" onclick="btnMCPromotionCode_Click"/>
                </td>
                </tr>
               </table>
...
<li>Offer is valid for MasterCard WorldCard holders.</li>
<li>Discount will be applicable subject to use of MasterCard identification as deal code at the time of redemption with KOD along with Promo Code: MCWCKOD001 at the time of redemption with KOD.</li>
<li>Offer is valid between -----------------------------------------. In order to be eligible for the offer, the booking must be between ---------------------------------------------.</li>
<li>In order to be eligible for the discount, the redemption with KOD must be done on or before -------------------------------.</li>
...
<li>KOD and MasterCarde right to terminate the offer at any point without prior communication or liability.</li>
