<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Seat-layout.aspx.cs" Inherits="AgentFlow_Seat_layout" %>
                    ...
                    <div class="ModalWindow">
                        <div id="div_seatlayo">
                            ...
                            <%if (Session["play_Val"] != null)
                              {
                                  if (Session["play_Val"].ToString() == "ZANGOORA")
                                  {
                                      ...
                                      if (Session["play_Val_Location"].ToString() == "November")
                                      {
                            %>
                            ...
                            <%
                                      ...
                                      {
                                           %>
                            <a href="../images/zangoora-seat-layout1.jpg" target="_blank" style="color: White">View</a>
                            <%
                                      }
                                  }
                                  else if (Session["play_Val"].ToString() == "CONCERT")
                                  { 
                            %>
                            ...
                            <%
                                  ...
                                  else if (Session["play_Val"].ToString() == "LIMITLESS")
                                  { 
                            %>
                              <a href="../images/Limitless-booking-engine-seat-layout.jpg" target="_blank" style="color: White">View</a>    
                                  <%
                                  }
                                  else
                                  {
                            ...
                            <%
                                      ...
                                      {
                                             %>
                            <a href="../images/jhumroo-seat-layout1.jpg" target="_blank" style="color: White">View</a>
                            <%
                                      }
                                  }
                              } %>
