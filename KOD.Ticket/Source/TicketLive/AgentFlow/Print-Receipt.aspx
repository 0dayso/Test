<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Receipt.master" CodeFile="Print-Receipt.aspx.cs" Inherits="AgentFlow_Print_Receipt" %>
...
<tr>
        ...
        <div>
           ...
           &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            <asp:Button ID="BtnBookMoreTickets" class="common-button" style="float:right;" runat="server" 
                Text="Book Again" onclick="BtnBookMoreTickets_Click" />    
        </div>
    </div>
