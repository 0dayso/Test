...
public partial class SumerCamp_HDFC_ReturnReceipt : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (ErrorNo == String.Empty)
            {
                ...
                if (trackid != String.Empty)
                {
                    ...
                    {
                        string redirectURL = "REDIRECT=" + KoDTicketingIPAddress + "SumerCamp/Print-Receipt.aspx" + qstring;
                ...
                Response.Write("REDIRECT=" + KoDTicketingIPAddress + "SumerCamp/Print-Receipt.aspx?err=pay");
            }
            else
            {
