...
public partial class SumerCamp_HDFC_FinalCall : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.Write("<script> location.replace('" + IpAddress + "SumerCamp/Print-Receipt.aspx?b=" + Request.QueryString["b"] + " '); </script>");
