...
public partial class Kod_SearchBooking : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((Request.QueryString["MMT"] == "" || Request.QueryString["MMT"] == null) && (Request.QueryString["MANA"] == "" || Request.QueryString["MANA"] == null) && (Request.QueryString["Indigo"] == "" || Request.QueryString["Indigo"] == null) && (Request.QueryString["MMTD"] == "" || Request.QueryString["MMTD"] == null) && (Request.QueryString["Valentine"] == "" || Request.QueryString["Valentine"] == null) && (Request.QueryString["Hotel"] == "" || Request.QueryString["Hotel"] == null) && (Request.QueryString["Yatra"] == "" || Request.QueryString["yatra"] == null) && (Request.QueryString["WMC"] == "" || Request.QueryString["WMC"] == null) && (Request.QueryString["NWMCT"] == "" || Request.QueryString["NWMCT"] == null) && (Request.QueryString["FAMILYOFFER"] == "" || Request.QueryString["FAMILYOFFER"] == null))
        {
    ...
    void Load_Play()
    {
        ...
        else if (Request.QueryString["MMTD"] == "s")
        {
            foreach (DataRow dr in dtlocation.Rows)
                if (dr[0].ToString() != "MANA" && dr[0].ToString() != "NEW YEAR")
        ...
        else if (dtlocation != null && dtlocation.Rows.Count > 0)
        {
            foreach (DataRow dr in dtlocation.Rows)
            {
                if (dr[0].ToString() != "NEW YEAR" && dr[0].ToString() != "FAMILYOFFER")
                ddl_Play.Items.Add(new ListItem(dr[0].ToString(), dr[0].ToString()));
            }
        }
