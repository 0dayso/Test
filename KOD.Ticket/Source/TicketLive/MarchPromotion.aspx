<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MarchPromotion.aspx.cs" Inherits="MarchPromotion" %>
        ...
        .seats-inside1
{
    width: 846px;
    float: left;
    background: url(images/march-promotion.jpg) no-repeat;
    overflow: auto;
    height: 489px;
    padding-left:245px;
    *padding-left:245px;
...
<body class="home-page-bg">
            ...
            <div class="seats-inside1">
                <div class="ticket-main">
                  ...
                  <td>
                    ...
                    <asp:DropDownList ID="ddl_Package1" runat="server" CssClass="text-small" Width="200px"  OnSelectedIndexChanged="ddl_Package1_SelectedIndexChanged" AutoPostBack="true">
                            <asp:ListItem Value="0">Select</asp:ListItem>
                            <asp:ListItem>Rs.1275</asp:ListItem>
                            <asp:ListItem>Rs.4999</asp:ListItem>
                            </asp:DropDownList>
                  ...
                  <td>
                        ...
                        <td class="style1" align="right">
                    <asp:DropDownList ID="ddl_Date" runat="server" CssClass="text-small" Width="200px"  OnSelectedIndexChanged="ddl_Date_SelectedIndexChanged" AutoPostBack="true">
                            <asp:ListItem Value="0">Select</asp:ListItem>
              </asp:DropDownList>
                  ...
                  <td>
                        ...
                        <td class="style1" align="right">
                    <asp:DropDownList ID="ddl_ShowTime" runat="server" CssClass="text-small" Width="200px"  OnSelectedIndexChanged="ddl_ShowTime_SelectedIndexChanged" AutoPostBack="true">
                            <asp:ListItem Value="0">Select</asp:ListItem>
              </asp:DropDownList>
                        ...
                        <td>:</td>
                        <td class="style1" align="right">
                       <asp:DropDownList ID="ddl_Quantity" runat="server" CssClass="text-small" Width="200px" AutoPostBack="true" >
                          <asp:ListItem Value="0">Select</asp:ListItem> 
                            </asp:DropDownList>
  ...
  <asp:LinkButton ID="Button2" CssClass="clickhere" runat="server" Text="Click Here"/></div>
    ...
    <div style="display: none">
        ...
        <cc1:ModalPopupExtender ID="ModalPopupExtender1" PopupControlID="Div_popup" BackgroundCssClass="modalBackground2"
        CancelControlID="Button3" TargetControlID="Button2" runat="server">
    </cc1:ModalPopupExtender>
    <div id="Div_popup" class="ModalWindow" style="display: none; width: 380px; height: 250px;"
        runat="server">
        <div style="overflow: auto; width: 330px; height: 200px; padding: 0px 10px 0px 10px">
        <h3>
                <center><u>Package Details</u></center></h3>
            <ol>
                <li><u><font color="red">Rs 4999 per couple:</font></u> Silver Category Show Ticket for Jhumroo, Welcome Drink, Culture Gully Smart Card Worth Rs.500 per person, 10% Discount on Retail Purchase at Culture Gully.</li>
                <br />
                <li><u><font color="red">Rs 1275:</font></u>Gold Category Show Ticket for Jhumroo, Welcome Drink, Culture Gully Smart Card Worth Rs.2500 per couple, 10% Discount on Retail Purchase at Culture Gully.</li>
                </ol>
                </div>
                <hr />

                 <asp:Button Text="Close" runat="server" CssClass="common-button" ID="Button3" />
                </div>
        ...
        <div style="overflow: auto; width: 530px; height: 460px; padding: 0px 10px 0px 10px">
           ...
           <%-- <b><font color="red">
            ...
            <ol>
                <li>Ticket once issued can't be reissued/replaced if misplaced/ stolen etc.</li>
                <li>All the rates are inclusive of applicable Government taxes as on date.</li>
                ...
                <li>Ticket is non-refundable. In case, the event  gets cancelled, Management of the Kingdom of Dream will revalidate the ticket for fresh date or  refund the net ticket price & taxes. Any cancellation will be duly notified through proper channels i.e. by Telephone/ Email/Media/ Internet etc. The service charge or any other charges paid for and included in the ticket sale, such as convenience charge or delivery charge paid for booking of the ticket will not be refunded.</li>
                <li>The event is subject to force majeure conditions. The management reserves a right to cancel the show or schedule it on an alternate date.</li>
                <li>This ticket  is strictly non-transferable and non refundable.</li>
                <li>consumption banned substances are strictly prohibited.</li>
                <li>The tickets cannot be redeemed with cash.</li>
                 <li>Please check date, time and  schedule of the performances for the day.</li>   
                 <li>The Artists/Schedule & Timing for the event  may change without prior notice .</li>         
                 <li>This  ticket is not valid for the shows i.e.  Zangoora and Jhumroo.</li>
                 ...
                 <li>Camera, baggage, bottles, cans/tins, weapons & any belongings are not allowed inside the event/venue. </li>
