<%@ Page Title="" Language="C#" MasterPageFile="~/Receipt.master" AutoEventWireup="true" CodeFile="Print-Receipt.aspx.cs" Inherits="NewYearPackages_Print_Receipt" %>
        ...
        <div id="DivPrint" style="overflow: auto; width: 100%"  style="height:600px">
            ...
            <%--    <tr>
               ...
               <td style="width: 213px">
                ...
                <td style="width: 597px">
                <asp:Label ID="lblCouple" runat="server" Text="Couple :"></asp:Label>
                ...
                <asp:Label ID="lblTeens" runat="server" Text="Teens :"></asp:Label>
                <asp:Label ID="lblTeensQnty" runat="server" />&nbsp;
                <asp:Label ID="lblKids" runat="server" Text="Kids :"></asp:Label>
                <asp:Label ID="lblKidsQnty" runat="server" />&nbsp;
                </td>
                </tr>
