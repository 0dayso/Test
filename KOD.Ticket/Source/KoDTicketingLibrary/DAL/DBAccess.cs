...
namespace KoDTicketing.DataAccessLayer
{
    ...
    public class DBAccess : IDisposable
    {
        ...
        */
        ...
        const string ConnectionStringMSTicket = "Server=115.112.32.12;Database=MSTicketDB_Live;User ID=KOD;Password=K1ng@123";

        const string ConnectionStringWebCRM = "server=182.71.214.114,1348;database=webcrm;uid=sancrm;pwd=K0d@2012;";
        
        const string ConnectionStringWebBooking = "server=122.180.79.189;database=NMTEST24APR14;uid=WEB;pwd=K1ng@123; Min Pool Size=0; Max Pool Size=100; Connect Timeout=600;Pooling=false;Connection Reset=true;";
        ...
        */
        ...
        static String _table_AudiMaster = "[NMTEST24APR14].[dbo].[NMTEST24APR14$Audi Master]";
        static String _table_AudiShowAllocation = "[NMTEST24APR14].[dbo].[NMTEST24APR14$Audi Show Allocation]";
        static String _table_ClassMaster = "[NMTEST24APR14].[dbo].[NMTEST24APR14$Class Master]";
        static String _table_BookingMaster = "[NMTEST24APR14].[dbo].[NMTEST24APR14$Booking Master]";
        static String _table_AudiRowMaster = "[NMTEST24APR14].[dbo].[NMTEST24APR14$Audi Row Master]";
        static String _table_ShowPricing = "[NMTEST24APR14].[dbo].[NMTEST24APR14$Show Pricing]";
        static String _table_PromotionMaster = "[NMTEST24APR14].[dbo].[NMTEST24APR14$Promotion Master]";
